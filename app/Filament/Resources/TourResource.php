        ...
        return $form
            ->schema([
                ...
                SpatieMediaLibraryFileUpload::make('tour_images')
                    ...
                    ->columnSpanFull(),
                Forms\Components\TextInput::make('itinerary_url')
                    ->label('Itinerary PDF Link (Google Drive)')
                    ->url()
                    ->placeholder('https://drive.google.com/file/d/...')
                    ->helperText('Paste Google Drive link for PDF itinerary. Make sure link is set to "Anyone with the link can view".')
